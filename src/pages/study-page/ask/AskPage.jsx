...
const AskPage = () => {
    ...
    return (
        ...
        <label className="block mb-2 w-full">
            ...
            <input type="text" placeholder="Toán, Vật lý, Lập trình,..." className="p-2 bg-gray-200 mt-1 block w-full rounded-lg h-10" value={title} onChange={(e)=>{setTitle(e.target.value)}}/>
        </label>
        ...
        <button className="mt-4 px-20 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">Đăng</button>
    </div>
    );
}
