const CategoryQuestion = () => {
    return (
        <div className="hidden sm:flex flex flex-col items-start p-5 m-1 relative top-10 min-w-[150px] h-full border border-gray-300 rounded-lg">
            <button className="flex flex-row py-2 items-center justify-center">
