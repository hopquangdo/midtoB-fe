    ...
    return (
        <Link key={question?.questionId} className="flex md:flex-col lg:flex-row lg:items-center border-b border-gray-300 p-5 "
            ...
            <div className="lg:m-2 flex md:flex-row lg:flex-col ">
                ...
                <div className="text-sm text-gray-600 md:m-2">{question.totalAnswers}</div>
                <div className="text-sm text-gray-600 md:m-2">{question.totalViews}</div>
            </div>
            <div className="cursor-pointer">
                ...
                <div className="flex flex-row items-center">
                    <div className="flex flex-row items-center m-1">
                        <label className="text-sm text-gray-500 p-1">Đăng bởi {question.asker.firstName}</label>
